...
let enemies=[],spawnTimer=null,raf=null,nextId=1,levelKills=0,spawned=0;
const cfg={
...
function announce(){
 ...
 $("#status").textContent="VAGUE "+level+" — PROTÉGEZ LE CENTRE";tone(620,.12,.035);setTimeout(()=>tone(850,.13,.03),130)
}
function spawnEnemy(){
